...
import (
	"os"
	"simple-clothes-shop/internal/repository" // 👈 อย่าลืมเช็ค path ให้ตรงกับโปรเจกต์คุณนะครับ
...
func NewAuthMiddleware(cacheRepo repository.CacheRepository) fiber.Handler {
