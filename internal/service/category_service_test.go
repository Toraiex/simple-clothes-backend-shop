package service_test // ใช้ _test ต่อท้ายเพื่อแยกบริบทของการเทสออกมา
...
// สร้างตัวปลอมของ ProductRepo ด้วย (เพราะ CategoryService ต้องการใช้)
...
func TestCreateCategory(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			categorySvc := service.NewCategoryService(catRepo, prodRepo)
