...
func NewOrderUsecase(repo domain.OrderRepository, cartRepo domain.CartRepository) domain.OrderUsecase {
	return &orderUsecase{
		repo:     repo,
		cartRepo: cartRepo,
	}
...
func (s *orderUsecase) Checkout(ctx context.Context, userID uint) error {
...
func (s *orderUsecase) GetByUserID(ctx context.Context, userID uint) ([]domain.Order, error) {
	return s.repo.GetByUserID(ctx, userID)
}

func (s *orderUsecase) GetByID(ctx context.Context, id uint) (*domain.Order, error) {
	return s.repo.GetByID(ctx, id)
}

func (s *orderUsecase) GetByIDForUser(ctx context.Context, userID uint, orderID uint) (*domain.Order, error) {
...
func (s *orderUsecase) CancelOrder(ctx context.Context, userID uint, orderID uint) error {
	order, err := s.repo.GetByID(ctx, orderID)
	if err != nil {
		return err
	}
...
func (s *orderUsecase) AdminUpdateStatus(ctx context.Context, orderID uint, newStatus domain.OrderStatus) error {
	order, err := s.repo.GetByID(ctx, orderID)
	if err != nil {
		return err
	}
